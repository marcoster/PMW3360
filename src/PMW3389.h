...
#define PMW3389_DATA_MOTION_IS_MOTION_MASK  0x80
#define PMW3389_DATA_MOTION_ON_SURFACE_MASK 0x08

#define PMW3389_BURST_DATA_SIZE 12
#define PMW3389_BURST_DATA_MIN_SIZE 6
...
{
    union {
        uint8_t buf[PMW3389_BURST_DATA_SIZE];
        struct {
            uint8_t motion;
            uint8_t observation;
            int16_t dx;
...
public:
  ...
  PMW3389_DATA readBurst(uint8_t);
